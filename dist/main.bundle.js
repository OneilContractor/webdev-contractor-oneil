    ...
    WidgetImageComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoutes.params.subscribe(function (params) {
            ...
            _this.widget = _this.widgetService.findWidgetById(_this.widgetId)
                ...
                _this.widget = widget;
                _this.widgetEdit = true;
                _this.nameImage = widget['name'];
                _this.textImage = widget['text'];
                _this.widthImage = widget['width'];
                _this.urlImage = widget['url'];
    ...
    WidgetYoutubeComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoutes.params.subscribe(function (params) {
            ...
            _this.widgetService.findWidgetById(_this.wgid)
                ...
                _this.widget = widget;
                _this.widgetEdit = true;
                _this.nameYoutube = widget['name'];
                _this.textYoutube = widget['text'];
                _this.widthYoutube = widget['width'];
                _this.urlYoutube = widget['url'];
            });
        });
    };
